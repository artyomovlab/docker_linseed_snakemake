...
## UMAP
### Original space
<img src="`r base64enc::dataURI(file = snakemake@input[[8]], mime = 'image/png', encoding = 'base64')`"></img>
...
```{r, echo=FALSE}
  ...
  basis_ <- data.frame(fread(snakemake@input[[7]])) %>%
...
<a href="`r base64enc::dataURI(file = snakemake@input[[6]], mime = 'text', encoding = 'base64')`">Download proportions</a><br>
<a href="`r base64enc::dataURI(file = snakemake@input[[7]], mime = 'text', encoding = 'base64')`">Download basis</a><br>